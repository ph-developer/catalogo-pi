...
export const ProductViewsCardChart = ({productViewEvents, products = [], className = ''}: Props) => {
    ...
    const chartData = useMemo(() => {
        ...
        for (let i = 0; i < period; i++) {
            ...
            data[label] = {label, ...Object.fromEntries(products.map(product => [product.id, 0]))}
        }
    ...
    }, [products, days, productViewEvents])
